...
<div class="header">
	<h2>Upload new crop pests and their solutions</h2>
</div> 
...
<form method="post" enctype="multipart/form-data" >
	...
	<tr class="input-group">
		<td><label>Pest name</label></td>
		<td><input type="text" name="pestname"></td>
	</tr>
  
  
	<tr class="input-group">
		<td><label>Pest Image</label></td>
	...
	<tr class="input-group">
		<td colspan="2"><a href = "pestuploads.php"> <button type="submit" name="submit" class="btn" href="pestuploads.php">Submit</button> </a></td>
	</tr>
</table>
</form>
<form>
<table border="1px">
	<tr><th>Pest Name</th><th>Pest Image</th><th>Solution</th></tr>
	<?php
	...
	while($row=mysqli_fetch_array($qry,MYSQLI_ASSOC)){
		...
		echo '<td>'; ?> <img src="<?php echo $row["uploadedfile"]; ?>" width="20%" height="10%"/> <?php echo '</td>';
