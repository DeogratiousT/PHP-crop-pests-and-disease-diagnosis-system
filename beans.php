...
<table border="1px" style=" align:center; width:100%;">
 <tr><td colspan="4"><h3><center>BEANS CROP DISEASES AND SOLUTIONS</center></h3></td></tr>
	<tr><th>Crop Part</th><th>Images</th><th>Disease Name</th><th>Solution</th></tr>
	<?php
	$con=new mysqli("localhost", "root", "", "crop");
	$qry=mysqli_query($con,"select croppart,uploadedfile,diseasename,solution FROM updates WHERE cropname = 'beans'");
